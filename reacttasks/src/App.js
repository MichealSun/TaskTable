...
getTasks() {
  axios.request({
    method:'get',
    url:'https://api.mlab.com/api/1/databases/reacttaksk/collections/tasks?apiKey=BYsJbIb6tp9TGV-wRmkH_KHCPnbIS-O4'
  }).then((response) => {
...
editState(task, checked) {
  axios.request({
    method:'put',
    url:'https://api.mlab.com/api/1/databases/reacttaksk/collections/tasks/'+task._id.$oid+'?apiKey=BYsJbIb6tp9TGV-wRmkH_KHCPnbIS-O4',
    data: {
      text: task.text,
      completed: checked
    }
    ...
    return (
      <div className="App">
       ...
       <Container>
         ...
         <Task onEditState={this.editState.bind(this)} tasks={this.state.tasks}/>
